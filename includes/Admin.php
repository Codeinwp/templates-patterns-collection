...
class Admin {
    ...
    public function register() {
        //$white_label = get_option('ti_white_label_inputs');
        //todo: Take Care of WhiteLabel @abaicus.
        $prefix = defined( 'NEVE_VERSION' ) ? '<span style="display: inline-block; margin-right: 5px; transform: scaleX(-1);">&crarr;</span>' : '';
        add_theme_page( __( 'Starter Sites', 'templates-patterns-collection' ), $prefix . __( 'Starter Sites', 'templates-patterns-collection' ), 'activate_plugins', $this->page_slug, [ $this, 'render_starter_sites' ] );
    }
