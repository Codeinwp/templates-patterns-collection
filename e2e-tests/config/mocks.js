...
export const CONTENT_XML_URL = 'https://demo.themeisle.com/neve-charity/export.xml';
...
export const FONT_PAIRS = {
    ...
    'playfair-display-source-sans-pro-1': fontPair('Playfair Display', 'Source Sans Pro'),
...
export async function mockOnboardingRoutes(page) {
    await page.route('**/wp-json/ti-demo-data/data*', (route) => fulfillJson(route, demoData));
